...
//the third return value indicates whether or not the block is a proof block
// This function is safe for concurrent access.
func (b *BlockChain) ProcessBlock(block *btcutil.Block, flags BehaviorFlags) (bool, bool, bool, error) {
	b.chainLock.Lock()
	...
	if checkpointNode != nil {
		...
		if blockHeader.Timestamp.Before(checkpointTime) {
			...
			return false, false, isProof, ruleError(ErrCheckpointTimeTooOld, str)
		}
		if !fastAdd {
			...
			if currentTarget.Cmp(requiredTarget) > 0 {
				...
				return false, false, isProof, ruleError(ErrDifficultyTooLow, str)
			}
		}
	}
	...
	return isMainChain, false, isProof, nil
}
